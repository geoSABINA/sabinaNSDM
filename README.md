...
7.<strong> What is the format of input data?</strong>
...
8. <strong>How are background points generated?</strong>
...
9. <strong>How do I generate uncertainty maps for ensemble models?</strong>
...
10. <strong>What statistical algorithms are used?</strong>
...
RF (Random Forests)
11. <strong>What types of validation are used?</strong>
