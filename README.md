...
3. How can I run a single-level (non-nested) model?
...
5. Is there a minimum number of species occurrences required?
...
7. What is the format of input data?
...
8. How are background points generated?
...
10. How do I generate uncertainty maps for ensemble models?
...
11. What statistical algorithms are used?
...
RF (Random Forests)
13. What types of validation are used?
